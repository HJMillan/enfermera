        ...
        <>
          ...
          <div className="bg-white p-4 rounded-[var(--radius-md)] border border-slate-200/80 shadow-[var(--shadow-rest)] transition-[transform,box-shadow,border-color] duration-[var(--duration-base)] ease-[var(--ease-standard)] hover:shadow-[var(--shadow-hover)]">
            <div className="flex items-center justify-between mb-1">
              <span className="text-[11px] font-bold uppercase tracking-wider text-rose-700 bg-rose-50 px-2 py-0.5 rounded-[var(--radius-sm)] border border-rose-100">
      ...
      {form.tieneUpp && (
        <div className="space-y-3.5 animate-fade-in">
          ...
          <div className="bg-white p-4 rounded-[var(--radius-md)] border border-slate-200/80 shadow-[var(--shadow-rest)] transition-[transform,box-shadow,border-color] duration-[var(--duration-base)] ease-[var(--ease-standard)] hover:shadow-[var(--shadow-hover)] space-y-3">
            <span className="group font-bold text-slate-800 text-sm flex items-center gap-1.5 border-b border-slate-100 pb-2">
              <Calendar className="w-4 h-4 text-rose-700 transition-transform duration-[var(--duration-fast)] ease-[var(--ease-standard)] group-hover:scale-110" />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 min-h-[44px]">
                  <button
                    ...
                    className={`rounded-[var(--radius-sm)] font-bold text-xs border transition-[transform,box-shadow,background-color,border-color,color] duration-[var(--duration-fast)] ease-[var(--ease-snappy)] active:scale-[0.98] cursor-pointer ${
                      form.pasoAreaCerrada
                        ? 'bg-rose-700 text-white border-rose-700 shadow-[var(--shadow-rest)] hover:scale-[1.015]'
                  ...
                  <button
                    ...
                    className={`rounded-[var(--radius-sm)] font-bold text-xs border transition-[transform,box-shadow,background-color,border-color,color] duration-[var(--duration-fast)] ease-[var(--ease-snappy)] active:scale-[0.98] cursor-pointer ${
                      !form.pasoAreaCerrada
                        ? 'bg-slate-700 text-white border-slate-700 shadow-[var(--shadow-rest)] hover:scale-[1.015]'
                        : 'bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300'
                    }`}
                  >
                    NO
                ...
                <div className="flex flex-wrap gap-1.5">
                  {['UTI', 'UCO', 'Quirófano', 'Shock Room', 'Piso / Sala'].map((area) => (
                    <button
                      ...
                      className={`text-xs font-semibold px-3 py-1.5 rounded-[var(--radius-sm)] border transition-[transform,box-shadow,background-color,border-color,color] duration-[var(--duration-fast)] ease-[var(--ease-snappy)] active:scale-[0.98] cursor-pointer ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-[var(--radius-sm)] p-1">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-[calc(var(--radius-sm)-4px)] bg-rose-600 text-white flex items-center justify-center transition-[transform,background-color] duration-[var(--duration-fast)] ease-[var(--ease-snappy)] active:scale-[0.98] cursor-pointer"
                >
                  ...
                  {COMMON_TREATMENTS.map((treat) => {
                    ...
                    return (
                      <button
                        ...
                        className={`text-xs font-semibold px-2.5 py-1.5 rounded-[var(--radius-sm)] border transition-[transform,box-shadow,background-color,border-color,color] duration-[var(--duration-fast)] ease-[var(--ease-snappy)] active:scale-[0.98] cursor-pointer ${
                          isSelected
                            ? 'bg-rose-700 text-white border-rose-700 shadow-[var(--shadow-rest)] hover:scale-[1.015]'
                            : 'bg-slate-50 text-slate-700 border-slate-200 hover:bg-slate-100 hover:border-slate-300'
                        }`}
          ...
          <div className="bg-white p-4 rounded-[var(--radius-md)] border border-slate-200/80 shadow-[var(--shadow-rest)] transition-[transform,box-shadow,border-color] duration-[var(--duration-base)] ease-[var(--ease-standard)] hover:shadow-[var(--shadow-hover)] space-y-3">
            <div className="group flex items-center gap-1.5 border-b border-slate-100 pb-2">
              <LifeBuoy className="w-4 h-4 text-sky-700 transition-transform duration-[var(--duration-fast)] ease-[var(--ease-standard)] group-hover:scale-110" />
          ...
          <div className="bg-white p-4 rounded-[var(--radius-md)] border border-slate-200/80 shadow-[var(--shadow-rest)] transition-[transform,box-shadow,border-color] duration-[var(--duration-base)] ease-[var(--ease-standard)] hover:shadow-[var(--shadow-hover)] space-y-2">
            <span className="group font-bold text-slate-800 text-sm flex items-center gap-1.5">
              <HeartPulse className="w-4 h-4 text-rose-700 transition-transform duration-[var(--duration-fast)] ease-[var(--ease-standard)] group-hover:scale-110" />
